package com.iobuilder.test.domain.movement.service.impl;

import com.iobuilder.test.domain.movement.mapper.MovementEntityMapper;
...
import com.iobuilder.test.infrastructure.repository.MovementRepository;
...
public class MovementServiceImpl implements MovementService {
    ...
    @Override
    public void saveWithdrawMovement(Wallet wallet, String type, String concept, BigDecimal amount) {
        Movement movement = new Movement();
        movement.setAmount(amount);
        movement.setConcept(concept);
        movement.setOriginAccount(wallet.getAccountNumber());
        movement.setType(type);
        movement.setOperationDate(LocalDate.now());
        movement.setWalletId(wallet.getId());
        movementRepository.save(movementEntityMapper.toEntity(movement));
